...
CREATE TABLE `purchased_books` (
  ...
  KEY `book_id` (`book_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `purchased_books_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `book` (`book_id`),
  CONSTRAINT `purchased_books_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user_signup_portal` (`user_id`)
...
INSERT INTO `purchased_books` VALUES (1,5,'u12','2025-06-29 19:29:04'),(3,8,'u12','2025-06-29 20:48:51');
